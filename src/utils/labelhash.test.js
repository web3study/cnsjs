...
test('test isDecrypted', () => {
  expect(
    isDecrypted(
      '[663072b30dcab381fd7418a1cbe2746c2dd42d79b3d0982109e624ff5d8d1d8d].cfx'
    )
  ).toBe(false)

  expect(isDecrypted('arachnid.cfx')).toBe(true)

  expect(isDecrypted('eth')).toBe(true)
  expect(isDecrypted('super.vitalik.cfx')).toBe(true)
  expect(
    isDecrypted(
